...
public class DownloadActivity extends ListActivity {
    ...
    private void initUI() {
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("UserNameToShare", un);
    ...
    private void beginDownload(String key) {
        File mediaStorageDir = new    File(Environment.getExternalStorageDirectory()
                + File.separator + "BonVoyageCloud");
        // This location works best if you want the created images to be shared   +"/"+AppHelper.getCurrUser()+key.indexOf("/")
        ...
        // file.
        File file = new File(mediaStorageDir.getPath() + "/" + key);
        //File file = new File(mediaStorageDir.getPath() + "/" + AppHelper.getCurrUser());


        // Initiate the download
        TransferObserver observer = transferUtility.download(Constants.BUCKET_NAME, key, file);
        //TransferObserver observer = transferUtility.download(Constants.BUCKET_NAME+"/"+AppHelper.getCurrUser(), key, file);
